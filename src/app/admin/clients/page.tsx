...
import { Users, Search, Loader2, ChevronRight, Calendar, CheckCircle2, Archive, ArchiveRestore, Trash2 } from 'lucide-react'
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex gap-3">
                        <div className="glass-card px-4 py-2 text-center">
                            <div className="text-2xl font-display font-bold text-accent">{activeClients.length}</div>
                            <div className="text-xs text-text-muted">Активных</div>
                        </div>
                        {archivedClients.length > 0 && (
                            <div className="glass-card px-4 py-2 text-center">
                                <div className="text-2xl font-display font-bold text-text-muted">{archivedClients.length}</div>
                                <div className="text-xs text-text-muted">В архиве</div>
                            </div>
                        )}
                    </div>
                </div>
