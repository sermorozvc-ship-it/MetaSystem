...
export interface ProgramData {
  ...
  weekVolume?: string         // объём текущей недели (**Объём недели:**)
  nutritionNote?: string      // питание / калории (**Питание / калории:** или **Питание:**)
  weightAlgorithm?: string    // алгоритм подбора веса (## Алгоритм подбора веса ...)
